...
llms="$outdir/llms.txt"
{
  echo "# splunkctl"
  echo ""
  echo "> Open-source MCP server and CLI for Splunk Enterprise SIEM and Splunk SOAR. Give AI agents access to 262 Splunk commands via Model Context Protocol, or operate your instances as code from the terminal."
  echo ""
