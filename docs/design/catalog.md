...
|---|---|---|
| MCP server | ✅ built | 5 meta-tools (help/usage/focus/unfocus/run), 259 auto-generated typed tools (array schemas for variadic/repeated params, explicit `yes` on guarded schemas, additionalProperties:false), subgroup-granular focus for the nested soar tree, 33 guide resources, protocol-level test suite |
